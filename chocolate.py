...
"distance" between available and required (chocolate) units: cost[i,j]= |B[i]-C[j]|/B[i]. The normalization is chosen to improve
numerical convergence. In this way, assignements of resources that do not require a cut have 0 cost, so they always minimize the cost
